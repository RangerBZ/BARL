...
from openrlhf.datasets import PromptAnswerDataset
from openrlhf.models import Actor
from openrlhf.trainer import BARLTrainer
...
def train(args):
    ...
    actor_optim = strategy.create_optimizer(
        actor, var_lr=args.actor_learning_rate, lr=args.actor_learning_rate, betas=args.adam_betas, weight_decay=args.l2
    )
    critic_optim = None
    ...
    prompts_dataset = PromptAnswerDataset(prompts_data, tokenizer, strategy, input_template=args.input_template)

    # prepare dataloader
    prompts_dataloader = strategy.setup_dataloader(
        prompts_dataset, args.rollout_batch_size // strategy.world_size, True, True, prompts_dataset.collate_fn
    )
    ...
    trainer.fit(args, prompts_dataloader, None, consumed_samples, num_update_steps_per_episodes)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_path", type=str, default="./ckpt/checkpoints_barl")
    ...
    parser.add_argument("--prompt_max_len", type=int, default=512, help="Max tokens for each prompt")
    ...
    parser.add_argument("--lambd", type=float, default=1.0, help="GAE lambd")
    ...
    parser.add_argument("--init_kl_coef", type=float, default=0.0, help="KL penalty")
    parser.add_argument(
        "--use_kl_estimator_k3",
        action="store_true",
        default=False,
    ...
    parser.add_argument("--output_key", type=str, default="response", help="answer key")
    ...
    parser.add_argument("--wandb_project", type=str, default="openrlhf_train")
    parser.add_argument(
        "--wandb_run_name",
        type=str,
