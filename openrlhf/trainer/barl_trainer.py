...
class BARLTrainer(ABC):
    ...
    def __init__(
        ...
        **generate_kwargs,
        ...
        #self.reward_token_ids = [convert_token_to_id(token, tokenizer) for token in self.args.reward_tokens]
    ...
    def barl_train(self, global_steps=0):
    ...
    def training_step_actor(self, experience: Experience) -> Dict[str, float]:
        ...
        # status
        status = {"actor_loss": actor_loss.item(), "loss": loss.item(), "ratio": ratio.item(), "actor_lr": self.actor_scheduler.get_last_lr()[0]}
        if self.pretrain_dataloader is not None:
    ...
    def _save_checkpoint(self, args, tag, client_states):
        if not self.disable_ds_ckpt:
            ...
            os.system("cp -r {} {}/".format(args.ckpt_path, args.save_path))
#            os.system("gsutil cp -R {} {}/ckpts/".format(args.ckpt_path, args.save_path))
